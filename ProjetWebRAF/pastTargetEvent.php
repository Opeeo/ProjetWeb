    ...
    <div class='row justify-content-center'>
        ...
        ";
            ...
            if(isset($_SESSION['mail'])) {
                $like = file_get_contents("http://localhost:3003/isUserLike/" . $_SESSION['id'] . "/" . $_GET['id']);
                echo $like;

                if ($like == "") {
                    echo "
                                    <a class='button-link' href='content/scriptLike.php?like=1&idEvent=". $_GET['id'] ."'>
                                        <button class='btn btn-lg btn-info btn-block btn-login text-uppercase font-weight-bold custom-button m-3'  style='width: 20em'>Like</button>
                                    </a>
                                ";
                } else {
                    echo "
                                    <a class='button-link' href='content/scriptLike.php?like=2&idEvent=". $_GET['id'] ."'>
                                        <button class='btn btn-lg btn-info btn-block btn-login text-uppercase font-weight-bold custom-button m-3'  style='width: 20em'>Unlike</button>
                                    </a>
                                ";
                }
            }
