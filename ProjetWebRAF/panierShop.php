  ...
  <body>
    ...
    <?php include("content/foot.php") ?>
      <?php if(!isset($_SESSION['mail'])) {
        ...
        <form method="post" action="content/paiement.php">
          <input type="hidden" class="prixTotal" name="prixTotal" value="salut" />
          <button type="submit" class="btn btn-success btn-lg btn-block">Paiement</button>
        </form>'; }
        echo '
