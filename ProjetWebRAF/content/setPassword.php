                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9 col-lg-8 mx-auto">
                                    ...
                                    <form method="post" action="scriptMdp.php" oninput='inputConfirmPassword.setCustomValidity(inputConfirmPassword.value != inputPassword.value ? "Les mots de passe doivent correspondrent." : "")'>
