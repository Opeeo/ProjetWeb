                            ...
                            <div class="row">
                                <div class="col-md-9 col-lg-8 mx-auto">
                                    ...
                                    <form method="post" action="scriptInscription.php" autocomplete="on"> 
                                        ...
                                        <p>Vous avez déjà un compte ? <a class="text-dark text-center" href="connexion.php">Connexion</a></p>
                                        <p><a class="text-dark text-center" href="../index.php">Retour à l'accueil</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
